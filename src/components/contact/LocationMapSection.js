                    ...
                    <div className="relative">
                        <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-gray-200 relative">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                                    <div className="text-center p-8">
                                        ...
                                        <div className="w-full h-32 bg-gray-300 rounded-lg flex items-center justify-center">
                                            <span className="text-gray-500 text-span-small-responsive">Interactive Map Area</span>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="absolute top-6 left-6 bg-white rounded-2xl shadow-xl p-6 max-w-xs">
                                ...
                                >
                                    Open Map
                                    <ArrowDown strokeColor={`stroke-gray-800 stroke-2`} className={`w-3 h-3 ml-2 transition-transform duration-200 -rotate-90`} />
                            ...
                            <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2">
                                <div class="relative w-10 h-10 -translate-x-1/2 -translate-y-1/2">
                                    ...
                                    <div class="absolute top-1/2 left-1/2 w-6 h-6 bg-green-500 rounded-full border-4 border-white -translate-x-1/2 -translate-y-1/2 z-10"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 lg:space-y-6">
                        ...
                        <div className="space-y-3 !mt-6">
                            ...
                            <div className="space-y-1 text-p-large-responsive text-gray-500">
                                <h4 className="text-h6-responsive">
                                    {locationData.name}
                                </h4>

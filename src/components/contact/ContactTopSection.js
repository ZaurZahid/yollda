                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col md:max-w-[80%]">
                            ...
                            <p className="text-p-large-responsive text-gray-600 leading-relaxed">
                                Email, call or complete the form to learn how Yollda can solve your messaging problem
                            </p>
                            <div className="mt-2">
                                <a
                                    href="mailto:info@yollda.ai"
                        ...
                        <div className="grid md:grid-cols-2 gap-8 lg:gap-10 mt-10 lg:mt-20">
                            <div>
                                ...
                                <p className="text-p-small-responsive text-gray-500 leading-relaxed">
                                    at the management level to support the UN Global Compact. This commitment is renewed annually.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-text-p-small-responsive text-gray-500 leading-relaxed">
                                    The UNGC is the world's largest voluntary corporate initiative, with stakeholders in more than 135 countries and 8,000+ signatories.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            <input
                                                ...
                                                className={`w-full bg-green-secondary-dark border ${errors.firstName ? 'border-red-400' : 'border-white/20'} rounded-xl px-4 py-2 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-200 text-input-small-responsive`}
                                            />
                                            {errors.firstName && (
                                                <p className="text-red-400 text-span-small-responsive mt-1">{errors.firstName}</p>
                                            )}
                                        </div>
                                        <div>
                                            <input
                                                ...
                                                className={`w-full bg-green-secondary-dark border ${errors.lastName ? 'border-red-400' : 'border-white/20'} rounded-xl px-4 py-2 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-200 text-input-small-responsive`}
                                            />
                                            {errors.lastName && (
                                                <p className="text-red-400 text-span-small-responsive mt-1">{errors.lastName}</p>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div className="relative">
                                            <SmsIcon strokeColor="stroke-white/60" className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5" />
                                            ...
                                            <input
                                                ...
                                                className={`w-full bg-green-secondary-dark border ${errors.email ? 'border-red-400' : 'border-white/20'} rounded-xl pl-12 pr-4 py-2 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-200 text-input-small-responsive`}
                                            />
                                        </div>
                                        {errors.email && (
                                            <p className="text-red-400 text-span-small-responsive mt-1">{errors.email}</p>
                                        )}
                                    </div>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <div className="flex-1">
                                                <input
                                                    ...
                                                    className={`w-full bg-green-secondary-dark border ${errors.phone ? 'border-red-400' : 'border-white/20'} rounded-xl px-4 py-2 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-200 text-input-small-responsive`}
                                                />
                                            </div>
                                        </div>
                                        {errors.phone && (
                                            <p className="text-red-400 text-span-small-responsive mt-1">{errors.phone}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        <div className="relative" ref={servicesDropdownRef}>
                                            <button
                                                ...
                                                className={`w-full bg-green-secondary-dark border ${errors.service ? 'border-red-400' : 'border-white/20'} rounded-xl px-4 py-3 text-left flex items-center justify-between text-white  transition-colors duration-200
                                                ${isServiceOpen & !errors.service ? 'focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent' : ''}
                                            `}
                                            >
                                                <span className={`text-input-small-responsive ${formData.service ? 'text-white' : 'text-white/60'}`}>
                                                    {formData.service || 'Services'}
                                                </span>
                                                <ArrowDown strokeColor={`stroke-gray-500`} className={`transition-transform duration-200 ${isServiceOpen ? 'rotate-180' : ''}`} />
                                            </button>
                                        ...
                                        {errors.service && (
                                            <p className="text-red-400 text-span-small-responsive mt-1">{errors.service}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        <div className="relative" ref={countryDropdownRef}>
                                            <button
                                                ...
                                                className={`w-full bg-green-secondary-dark border ${errors.country ? 'border-red-400' : 'border-white/20'} rounded-xl px-4 py-3 text-left flex items-center justify-between text-white  transition-colors duration-200
                                                ${isCountryOpen & !errors.country ? 'focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent' : ''}
                                            `}
                                            >
                                                <span className={`text-input-small-responsive ${formData.country ? 'text-white' : 'text-white/60'}`}>
                                                    {formData.country || 'Country'}
                                                </span>
                                                <ArrowDown strokeColor={`stroke-gray-500`} className={`transition-transform duration-200 ${isCountryOpen ? 'rotate-180' : ''}`} />
                                            </button>
                                        ...
                                        {errors.country && (
                                            <p className="text-red-400 text-span-small-responsive mt-1">{errors.country}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        <div className="relative">
                                            <textarea
                                                ...
                                                rows={4}
                                                maxLength={120}
                                                className={`w-full bg-green-secondary-dark border ${errors.message ? 'border-red-400' : 'border-white/20'} rounded-xl px-4 py-2 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-light-green focus:border-transparent transition-all duration-200 text-input-small-responsive resize-none`}
                                            />
                                        ...
                                        {errors.message && (
                                            <p className="text-red-400 text-span-small-responsive mt-1">{errors.message}</p>
                                        )}
                                    </div>

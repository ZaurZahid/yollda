...
export default function YolldaPartnerSection() {
  ...
  const benefits = [
    {
      id: 1,
      title: t("signup_page.partner_section.benefits.benefit1.title"),
      description: t(
        "signup_page.partner_section.benefits.benefit1.description"
      ),
      icon: <Devices className="w-8 h-8" fillColor={"fill-green-dark"} />,
    },
    {
      id: 2,
      title: t("signup_page.partner_section.benefits.benefit2.title"),
      description: t(
        "signup_page.partner_section.benefits.benefit2.description"
      ),
      icon: <SearchAlt className="w-8 h-8" fillColor={"fill-green-dark"} />,
    },
    {
      id: 3,
      title: t("signup_page.partner_section.benefits.benefit3.title"),
      description: t(
        "signup_page.partner_section.benefits.benefit3.description"
      ),
      icon: (
        ...
        <div className="mb-8 md:mb-16">
          <h2 className="font-secondary text-h2-responsive uppercase font-bold text-green-dark mb-4 leading-tight">
            ...
            <span className="text-light-green">
              {t("signup_page.partner_section.sub_heading")}
            </span>
          </h2>

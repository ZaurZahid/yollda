                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <div className="relative" ref={countryCodeDropdownRef}>
                                                    <button
                                                        ...
                                                        className={`bg-gray-50 w-[130px] h-11 border border-gray-300 rounded-xl px-3 py-2 text-gray-700 flex items-center space-s-2 hover:bg-gray-100 transition-colors duration-200 min-w-[100px]

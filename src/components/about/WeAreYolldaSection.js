export default function WeAreYolldaSection() {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-20 lg:gap-12 items-center mt-10">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-2">
                            <p className="text-span-large-responsive text-white/80 font-medium">
                                Yollda is your trusted
                            </p>

                            <h4 className="text-h4-responsive font-bold leading-tight">
                                Azərbaycanda sürücülük edin və pul qazanın
                            </h4>
                        </div>

                        {/* Additional Description */}
                        <p className="text-p-large-responsive mt-4 text-white/90 leading-relaxed max-w-lg">
                            Şəhərlərdə həyat seviyyəsini yaxşılaşdırmaq üçün təcrübəmizi və aktual
                            məlumatları bölüşməkdən məmnunuq.
                        </p>
                    ...
                    <div className="relative">
                        <div className="relative overflow-hidden rounded-3xl shadow-2xl group">
                            <img
                                src="https://images.pexels.com/photos/3964704/pexels-photo-3964704.jpeg?auto=compress&cs=tinysrgb&w=800"

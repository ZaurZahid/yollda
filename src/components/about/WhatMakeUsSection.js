...
const carouselSlides = [
    {
        ...
        description: "We never sacrifice long-term value for short-term results. We think big and optimise for what's best for the whole company, not only one team. Whenever we see problems outside our direct responsibility, we speak up and help.",
        buttonText: "All jobs",
    ...
    },
    {
        ...
        description: "We believe in building lasting relationships with our drivers and partners. Our platform connects communities and creates opportunities for sustainable income while ensuring safety and reliability on every journey.",
        buttonText: "Join us",
    ...
    },
    {
        ...
        description: "We leverage cutting-edge technology to provide seamless roadside assistance. Our smart routing algorithms and real-time tracking ensure that help arrives exactly when and where you need it most.",
            ...
            <div className="max-w-[1440px] w-full px-6 sm:px-8 md:px-16 lg:px-20">
                <div className="flex flex-col">
                    ...
                    <p className="lg:w-[48%] text-h6-responsive mt-6 text-green-dark">
                        We want to work with collaborative and pragmatic people who enjoy
                        seeing and helping those around them succeed.
                    </p>
                </div>

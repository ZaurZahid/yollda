            ...
            <div className="max-w-[1440px] w-full px-6 sm:px-8 md:px-16 lg:px-20">
                <div className="flex flex-col text-center">
                    ...
                    <p className="lg:w-[40%] mx-auto text-p-responsive mt-6 text-gray-400">
                        We value high inner drive. Although we can’t impact someone’s
                        motivation, we work to inspire our high-performing teams to deliver their best consistently. Some perks may differ depending on your location and role.
                    </p>
                </div>

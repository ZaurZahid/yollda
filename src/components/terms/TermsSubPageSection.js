        ...
        <div className="w-full flex justify-center py-12 md:py-20">
            <div className="max-w-[1440px] w-full px-6 sm:px-8 md:px-16 lg:px-20">
                ...
                <div className="flex flex-col">
                    ...
                    <div
                        className="lg:w-[80%]
                        prose-h1:text-h1-responsive prose-h2:text-h2-responsive prose-h3:text-h3-responsive prose-h4:text-h4-responsive prose-h5:text-h5-responsive prose-h6:text-h6-responsive
                        prose-h1:mt-12 prose-h1:mb-8 
                        prose-h2:mt-12 prose-h2:mb-8 
                        prose-h3:mt-8 prose-h3:mb-6
                        prose-h4:mt-8 prose-h4:mb-6
                        prose-h5:mt-6 prose-h6:mt-4
                        prose-h5:mt-4 prose-h6:mt-0

                        prose-headings:text-green-dark prose-headings:!font-bold
                        prose-p:text-gray-500
                        prose-a:text-light-green prose-a:no-underline hover:prose-a:text-green-dark
                        prose-strong:text-green-dark

...
export default function TermsConditionsSection() {
    const [selectedCountry, setSelectedCountry] = useState('Azerbaijan (Azerbaijan)');
                ...
                <div className="text-center">
                    ...
                    <div className="flex justify-center mt-8">
                        <div className="relative w-full max-w-sm">
                            ...
                            >
                                <span className="text-span-responsive font-medium">{selectedCountry}</span>
                                <ArrowDown strokeColor={`stroke-gray-500`} className={`transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`} />
                            </button>

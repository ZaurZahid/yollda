...
//     description:
//       "Register one or more tow trucks under Yollda Business, dispatch jobs, and track earnings from a single dashboard.",
//     buttonText: "Register to Tow",
//     image:
...
//     description:
//       "Become an official Yollda Training Partner. Offer certified programs to prepare new Tow Drivers and Roadside Assistants. Help them get verified and ready to earn—while you grow your own business.",
...
export default function EarnWithSection({ alternatingSlides }) {

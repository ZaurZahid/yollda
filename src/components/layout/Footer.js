                ...
                <div className="max-w-[1440px] w-full px-6 sm:px-8 md:px-16 lg:px-20">
                    ...
                    <div class="flex flex-col lg:flex-row lg:justify-between mb-12">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 mt-12 lg:mt-0">
                            {/* Products Column */}
                            <div>
                                <h4 className="span-small-responsive font-semibold mb-4 text-white">{t('footer.headings.products')}</h4>
                            ...
                            {/* Earn Column */}
                            <div>
                                <h4 className="span-small-responsive font-semibold mb-4 text-white">{t('footer.headings.earn')}</h4>
                                <ul className="space-y-3">
                                    <li>
                                        <a
                            ...
                            {/* Company Column */}
                            <div>
                                <h4 className="span-small-responsive font-semibold mb-4 text-white">{t('footer.headings.company')}</h4>
                                <ul className="space-y-3">
                                    <li>
                                        <a
                                            href={`/about/${locale}`}
                            ...
                            {/* Support Column */}
                            <div>
                                <h4 className="span-small-responsive font-semibold mb-4 text-white">{t('footer.headings.support')}</h4>
                                <ul className="space-y-3">
                                    <li>
                                        <a
                            ...
                            {/* Safety Column */}
                            <div>
                                <h4 className="span-small-responsive font-semibold mb-4 text-white">{t('footer.headings.safety')}</h4>
                                <ul className="space-y-3">
                                    <li>
                                        <a
                                            href={`/safety/${locale}`}
                            ...
                            {/* Locations Column */}
                            <div>
                                <h4 className="span-small-responsive font-semibold mb-4 text-white">{t('footer.headings.locations')}</h4>
                                <ul className="space-y-3">
                                    <li>
                                        <a
                    ...
                    <div className="border-t border-light-secondary-green pt-8">
                        <div className="flex flex-col lg:flex-row justify-between items-center">
                            ...
                            <div className="flex justify-center space-s-4">
                                ...
                                {siteData?.[0]?.twitter && <a href={siteData[0].twitter} target="_blank" rel="noopener noreferrer" className="hover:text-blue-800">
